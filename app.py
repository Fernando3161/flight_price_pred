...
import pickle
import pandas as pd
from src.common import MODEL_RESSULTS_DIR
...
def predict():
    if request.method=='POST':
        ...
        Day_of_Week= pd.to_datetime(dep_time, format="%Y-%m-%dT%H:%M").day_of_week
        Day_of_Year= pd.to_datetime( dep_time, format="%Y-%m-%dT%H:%M").day_of_year
